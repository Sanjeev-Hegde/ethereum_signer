...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "sanjeev.hegde@etc.com:hello", "bar@example.com:world"
    };
    /**
...
/*                if(!fileExistance("UTC")){
                ...
                File keyFile = getFileStreamPath("UTC");
                ...
                Boolean keyFilePresent = sharedPref.getBoolean("keyFilePresent",false);
//                String keyFileName = sharedPref.getString("keyFileName","");
//                System.out.println("key file present:"+keyFilePresent);
